...
//   function getNiceErrorMessage(err: any) {
//     // Axios error shape
//     const details =
...
//     const msg = typeof details === "string" ? details : "Upload failed";

//     // common timeout detection
//     if (
//       msg.toLowerCase().includes("timeout") ||
//       err?.code === "ECONNABORTED" ||
//       err?.response?.data?.details?.toLowerCase?.().includes("timeout")
//     ) {
//       return "Upload timed out. Try a smaller video or check your internet speed (Cloudinary can timeout on large uploads).";
//     }
...
//           setProgress(pct);
//         },
//         // Optional: prevents axios from timing out on slow uploads
//         // timeout: 0,
//       });
...
//     } catch (error: any) {
//       console.error(error);
//       setNotice({ type: "error", text: getNiceErrorMessage(error) });
//     } finally {
//       setIsUploading(false);
//     }
//   };
